...
function OpeningCeremony(){ //main func
    setTimeout(()=>{console.log("Let the games begin")},1000);
    setTimeout(()=>{Race100M(score)},3000);
}
function Race100M(score){ //first fucn to be call
    var event="Race100M"
...
function LongJump(score){ //callback func
    var event="LongJump"
    console.log("Event : "+event)
    console.log("")
...
function HighJump(score){ //callback func
    var event="HighJump"
    console.log("Event : "+event)
    console.log("")
...
function AwardCeremony(score){ //callback func
...
function getRndInteger(min, max) { //callback func
